  ...
  "inline-flex items-center justify-center rounded border px-1.5 py-0.5 text-[11px] font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none transition-colors overflow-hidden",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.05)] text-muted-foreground [a&]:hover:text-foreground",
        destructive:
          "border-transparent bg-destructive/20 text-destructive [a&]:hover:bg-destructive/30",
        outline:
          "border-[rgba(255,255,255,0.08)] text-muted-foreground [a&]:hover:text-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
