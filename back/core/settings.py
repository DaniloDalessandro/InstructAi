...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "InstructAI <noreply@instructai.com>")
SYSTEM_NAME = os.environ.get("SYSTEM_NAME", "InstructAI")
